...
class Card extends Model
{
    ...
    {
        return $this->belongsTo(\App\Domain\Lists\Models\ListModel::class, 'list_id');
    }
    ...
    {
        return $this->hasMany(\App\Domain\Attachments\Models\Attachment::class)
                    ->orderBy('created_at', 'desc');
    }
    ...
    {
        return $this->belongsToMany(\App\Models\User::class, 'card_user')
                    ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(\App\Domain\Labels\Models\Label::class, 'card_label')
                    ->withTimestamps();
    }
    ...
    {
        return $this->hasMany(\App\Domain\Checklist\Models\ChecklistItem::class)
                    ->orderBy('position');
    }
